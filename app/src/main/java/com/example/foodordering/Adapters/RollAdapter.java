...
public class RollAdapter extends RecyclerView.Adapter<RollAdapter.ViewHolder> {
    ...
    public RollAdapter(ArrayList<RollModel> rolllist, Context context,UpdateSelectedItemsInterface updateSelectedItemsInterface) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        RollModel rollModel = rolllist.get(position);


        holder.image.setImageResource(rollModel.getImage());
        holder.title.setText(rollModel.getTitle());
        holder.fee.setText(String.valueOf("₹ "+rollModel.getFee()));


        holder.description.setText(rollModel.getDescription());
        holder.time.setText(String.valueOf(rollModel.getTime()));
        holder.calories.setText(String.valueOf(rollModel.getCalories()));
        holder.star.setText(String.valueOf(rollModel.getStar()));

        for (OrderListModel o : ((UpdateSelectedItemsInterface) ApplicationMain.getMyContext()).getItems()){
            if(o.getName().equals(rollModel.getTitle())){
        ...
        holder.cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                name = rollModel.getTitle();
                price = rollModel.getFee();
                image = rollModel.getImage();
