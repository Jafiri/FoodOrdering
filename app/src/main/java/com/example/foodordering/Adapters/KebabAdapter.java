...
public class KebabAdapter extends RecyclerView.Adapter<KebabAdapter.ViewHolder> {
    ...
    ArrayList<KebabModel> kebablist;
    Context context;
    ...
    public KebabAdapter(ArrayList<KebabModel> kebablist, Context context, UpdateSelectedItemsInterface updateSelectedItemsInterface) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        KebabModel kebabModel = kebablist.get(position);

        holder.image.setImageResource(kebabModel.getImage());
        holder.title.setText(kebabModel.getTitle());
        holder.fee.setText(String.valueOf("₹ "+kebabModel.getFee()));



        holder.description.setText(kebabModel.getDescription());
        holder.time.setText(String.valueOf(kebabModel.getTime()));
        holder.calories.setText(String.valueOf(kebabModel.getCalories()));
        holder.star.setText(String.valueOf(kebabModel.getStar()));

        for (OrderListModel o : ((UpdateSelectedItemsInterface) ApplicationMain.getMyContext()).getItems()){
            if(o.getName().equals(kebabModel.getTitle())){
        ...
        holder.cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                name = kebabModel.getTitle();
                price = kebabModel.getFee();
                image = kebabModel.getImage();
